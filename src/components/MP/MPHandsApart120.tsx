...
export const MPHandsApart120 = ({ isLoading, setIsLoading }: MPProps) => {
  ...
  const onResults = (results) => {
    ...
    if (lHandAngle < 30 && rHandAngle < 30 && stage === 'Опустите руку') {
      stage = 'Отведите руку на 120 градусов'
    ...
    if (lHandAngle > neededAngle && stage == 'Отведите руку на 120 градусов') {
      if (suggestedText == '') {
        setComment('')
    ...
    if (rHandAngle > neededAngle && stage == 'Отведите руку на 120 градусов') {
      if (suggestedText == '') {
        setComment('')
        counterCondition = true
      }
